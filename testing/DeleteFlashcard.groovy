...
def deleteFlashcardBtn = el('DeleteFlashcardBtn')
def logoutBtn         = el('LogoutButton')

KeywordUtil.logInfo('TEST CASE: Delete Flashcard Started')
...
KeywordUtil.logInfo('Opening Flashcards')

Windows.click(flashcardMenuBtn)
Windows.delay(2)

KeywordUtil.logInfo('Deleting Flashcard')

Windows.click(deleteFlashcardBtn)
Windows.delay(2)
...
KeywordUtil.logInfo('TEST CASE PASSED: Flashcard Deleted Successfully')
