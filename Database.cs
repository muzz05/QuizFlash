...
namespace QuizFlash
{
    public class Database : IDisposable
    {
        ...
        private readonly string remoteConnection = "server=mysqlservice-muzamilsahab05-ede7.g.aivencloud.com;user=avnadmin;database=QuizFlash;password=AVNS_DraTD0zzal8fueGr8fn;port=23609";
